...
describe("jqLite", () => {
  ...
  describe("css", () => {
    ...
    it("should correctly handle dash-separated and camelCased properties", () => {
      ...
      expect(jqA.css("z-index")).toBe("", "auto");
      expect(jqA.css("zIndex")).toBe("", "auto");

      jqA.css({ zIndex: 5 });

      expect(jqA.css("z-index")).toBe("5", 5);
      expect(jqA.css("zIndex")).toBe("5", 5);

      jqA.css({ "z-index": 7 });

      expect(jqA.css("z-index")).toBe("7", 7);
      expect(jqA.css("zIndex")).toBe("7", 7);
    });
