describe("uiView", function () {
  ...
  describe("scrollIntoView", function () {
    ...
    it("should scroll element into view after timeout", inject(function (
      $uiViewScroll,
      $timeout,
    ) {
      $uiViewScroll(elem);
    ...
    it("should return the promise from the timeout", inject(function (
      $uiViewScroll,
      $timeout,
    ) {
  ...
  describe("useAnchorScroll", function () {
    ...
    it("should call $anchorScroll", inject(function (
      $uiViewScroll,
      $anchorScroll,
    ) {
      $uiViewScroll();
