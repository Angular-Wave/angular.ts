describe("UrlMatcher", function () {
  ...
  it("should parse parameter placeholders", function () {
    ...
    expect(matcher.parameters().map(prop("id"))).toEqual([
      "id",
      "type",
      "repeat",
      "from",
  ...
  describe(".append()", function () {
    it("should append matchers", function () {
      ...
      expect(params.map(prop("id"))).toEqual([
        "id",
        "type",
        "from",
        "repeat",
  ...
  describe("multivalue-path-parameters", function () {
    ...
    it("should be split on - in url and wrapped in an array if array: true", inject(function (
      $location,
    ) {
      const m = $umf.compile("/foo/:param1", {
        state: { params: { param1: { array: true } } },
...
describe("urlMatcherFactoryProvider", function () {
  describe(".type()", function () {
    ...
    it("should handle arrays properly with config-time custom type definitions", inject(function (
      $stateParams,
    ) {
...
describe("urlMatcherFactory", function () {
  ...
  describe("typed parameters", function () {
    ...
    it("should accept injected function definitions", inject(function (
      $stateParams,
    ) {
    ...
    it("should accept annotated function definitions", inject(function (
      $stateParams,
    ) {
  ...
  describe("optional parameters", function () {
    ...
    describe("default values", function () {
      ...
      describe("squash policy", function () {
        ...
        it(": true should squash the default value and one slash", inject(function (
          $stateParams,
        ) {
        ...
        it(": false should not squash default values", inject(function (
          $stateParams,
        ) {
        ...
        it(": '' should squash the default value to an empty string", inject(function (
          $stateParams,
        ) {
          const m = getMatcher("");
        ...
        it(": '~' should squash the default value and replace it with '~'", inject(function (
          $stateParams,
        ) {
          const m = getMatcher("~");
