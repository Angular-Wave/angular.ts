...
describe("$compile", function () {
  ...
  //   it("should observe interpolated attrs", inject(($rootScope, $compile) => {
  ...
  //     )($rootScope);
  //     $rootScope.$digest();
  //     expect(element[0].outerHTML.replace(' selected="selected"', "")).toEqual(
  //       '<select ng:model="x">' +
  ...
  //     module(($interpolateProvider, $compileProvider) => {
  //       $interpolateProvider.startSymbol("##").endSymbol("]]");
  ...
  //     () => {
  //       element = $compile(
  //         "<div>##hello|uppercase]]|<div my-directive></div></div>",
  //       )($rootScope);
  ...
  //     module(($compileProvider, $interpolateProvider) => {
  ...
  //       $templateCache.put(
  //         "myDirective.html",
  //         "<span>{{hello}}|{{hello|uppercase}}</span>",
  //       );
  //       element = $compile(
  //         "<div>##hello|uppercase]]|<div my-directive></div></div>",
  //       )($rootScope);
  ...
  //             $rootScope.$apply();
  //             expect(element.hasClass("interpolated");
  //           });
  //         },
  //       );
  //     },
  ...
  //   it(
  //     "should configure comment directives true by default",
  //     module(($compileProvider) => {
  ...
  //   it(
  //     "should return self when setting commentDirectivesEnabled",
  //     module(($compileProvider) => {
  ...
  //   it(
  //     "should configure css class directives true by default",
  //     module(($compileProvider) => {
  ...
  //   it(
  //     "should return self when setting cssClassDirectivesEnabled",
  //     module(($compileProvider) => {
  ...
  //     expect(log[0]).toEqual("tA; tB; tC; preA; preB; preC; postC; postB; postA");
  //   });
  ...
  //     it("should not automatically sanitize a[href]", inject((
  //       $compile,
  //       $rootScope,
  //     ) => {
  ...
  //     it("should not automatically sanitize img[src]", inject((
  //       $compile,
  //       $rootScope,
  //     ) => {
  //       // Breaking change in https://github.com/angular/angular.js/pull/16378
  ...
  //     it("should automatically sanitize img[srcset]", inject((
  //       $compile,
  //       $rootScope,
  //     ) => {
  //       element = $compile("<img></img>")($rootScope);
  ...
  //     it("should not accept trusted values for img[srcset]", inject((
  //       $compile,
  //       $rootScope,
  //       $sce,
  //     ) => {
  ...
  //         "$compile",
  //         "srcset",
  //         "Can't pass trusted values to `$set('srcset', value)`: \"trustme:foo()\"",
  //       );
  //     });
  //   });
  // });
  ...
  //       module("my");
  //       inject(($compile, $rootScope, $exceptionHandler, $log) => {
  ...
  //       angular.module("my", []).component("dcc", {
  ...
  //       angular.module("my", []).component("c1", {
  //         controller: TestController,
  ...
  //   it("should sanitize all uris in srcset", inject(($rootScope, $compile) => {
  //     element = $compile('<img srcset="{{testUrl}}"></img>')($rootScope);
  //     const testSet = {
