...
export class UrlRuleFactory {
     ...
     * ```
     */
    fromUrlMatcher(urlMatcher: any, handler: any): BaseUrlRule & {
        urlMatcher: any;
     ...
     * ```
     */
    fromState(stateOrDecl: any, stateService: any, globals: any): BaseUrlRule & {
        urlMatcher: any;
        matchPriority: (params: any) => number;
        type: string;
    } & {
     ...
     * ```
     */
    fromRegExp(regexp: any, handler: any): BaseUrlRule & {
        regexp: any;
        type: string;
    };
}
