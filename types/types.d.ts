export namespace angular {
    ...
    type InjectorService = {
         ...
         */
        invoke: (arg0: angular.Injectable<Function | ((...args: any[]) => T)>, arg1: any | undefined, arg2: any | undefined) => T;
        /**
         * Add and load new modules to the injector.
         */
        loadNewModules: (arg0: Array<angular.Module | string | angular.Injectable<(...args: any[]) => void>>) => void;
        /**
         * A map of all the modules loaded into the injector.
         */
        modules: {
            [x: string]: angular.Module;
        };
        /**
