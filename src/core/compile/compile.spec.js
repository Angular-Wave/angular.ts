...
describe("$compile", () => {
  ...
  fit("compiles element directives from a single element", () => {
    ...
    var el = createElementFromHTML("<my-directive></my-directive>");
    $compile(el);
  ...
  fit("does not apply to classes when no restrict given", () => {
    ...
    reloadModules();
    var el = createElementFromHTML('<div class="my-directive"></div>');
    $compile(el);
  ...
  describe("attributes", () => {
    function registerAndCompile(dirName, domString, callback) {
      ...
      reloadModules();
      var el = createElementFromHTML(domString);
      $compile(el);
    ...
    fit("shares attributes between directives", () => {
      ...
      reloadModules();
      var el = createElementFromHTML("<div my-dir my-other-dir></div>");
      $compile(el);
    ...
    fit("calls observer on next $digest after registration", () => {
      registerAndCompile(
        "myDirective",
        '<my-directive some-attribute="42"></my-directive>',
  ...
  describe("linking", () => {
    ...
    fit("calls directive link function with scope", () => {
  ...
  fit("links children when parent has no directives", async () => {
    ...
    reloadModules();
    var el = createElementFromHTML("<div><div my-directive></div></div>");
    $compile(el)($rootScope);
    await wait();
  ...
  fit("invokes multi-element directive link functions with whole group", () => {
    var givenElements;
    registerDirectives("myDirective", () => {
      return {
        multiElement: true,
  ...
  fit("gives inherited scope to all directives on element", async () => {
    var givenScope;
    registerDirectives({
      myDirective: () => {
        return {
  ...
  fit("creates an isolate scope when requested", async () => {
    var givenScope;
    registerDirectives("myDirective", () => {
      return {
        scope: {},
  ...
  fit("does not share isolate scope with other directives on the element", async () => {
    var givenScope;
    registerDirectives({
      myDirective: () => {
        return {
  ...
  fit("does not use isolate scope on child elements", async () => {
    var givenScope;
    registerDirectives({
      myDirective: () => {
        return {
  ...
  fit("does not allow two isolate scope directives on an element", async () => {
    registerDirectives({
      myDirective: () => {
        return {
          scope: {},
  ...
  fit("allows observing attribute to the isolate scope", async () => {
  ...
  fit("sets initial value of observed attr to the isolate scope", async () => {
    var givenScope;
    registerDirectives("myDirective", () => {
      return {
        scope: {
    ...
    reloadModules();
    var el = createElementFromHTML('<div my-directive an-attr="42"></div>');
    $compile(el)($rootScope);
    await wait();
    expect(givenScope.anAttr).toEqual("42");
  });
  ...
  fit("allows aliasing expression attribute on isolate scope", async () => {
    ...
    reloadModules();
    var el = createElementFromHTML('<div my-directive the-attr="42"></div>');
    $compile(el)($rootScope);
    await wait();
  ...
  fit("allows binding two-way expression to isolate scope", async () => {
    var givenScope;
    registerDirectives("myDirective", () => {
      return {
        scope: {
  ...
  describe("controllers", () => {
    ...
    fit("gets scope, element, and attrs through DI", () => {
      ...
      reloadModules();
      var el = createElementFromHTML('<div my-directive an-attr="abc"></div>');
      $compile(el)($rootScope);
    ...
    fit("has isolate scope bindings available during construction", () => {
      ...
      reloadModules();
      var el = createElementFromHTML('<div my-directive="abc"></div>');
      $compile(el)($rootScope);
  ...
  describe("template", () => {
    ...
    fit("uses isolate scope for template contents", async () => {
      ...
      reloadModules();
      var el = createElementFromHTML('<div my-directive="42"></div>');
      $compile(el)($rootScope);
      await wait();
  ...
  describe("templateUrl", () => {
    ...
    fit("immediately empties out the element", async () => {
      ...
      reloadModules();
      var el = createElementFromHTML("<div my-directive>Hello</div>");
      $compile(el);
      await wait();
    ...
    fit("retains isolate scope directives from earlier", (done) => {
      ...
      reloadModules();
      var el = createElementFromHTML(
        '<div my-directive="42" my-other-directive></div>',
      );
  ...
  describe("transclude", () => {
    ...
    fit("contents are destroyed along with transcluding directive", async () => {
      ...
      reloadModules();
      var el = createElementFromHTML(
        "<div my-transcluder><div my-inner-directive>TEST</div>",
      );
      $compile(el)($rootScope);
      ...
      registerDirectives({
        myTranscluder: function ($compile) {
          return {
            transclude: true,
            link: function (scope, element, attrs, ctrl, transclude) {
              var customTemplate = createElementFromHTML(
  ...
  describe("element transclusion", () => {
    ...
    it("includes directive attribute value in comment", () => {
      ...
      reloadModules();
      var el = createElementFromHTML(
        "<div><div my-transcluder=42></div></div>",
      );
    ...
    it("calls lower priority compile with original", () => {
      ...
      reloadModules();
      var el = createElementFromHTML(
        "<div my-other-directive my-transcluder></div>",
      );
  ...
  describe("interpolation", () => {
    ...
    it("fires observers on attribute expression changes", async () => {
      ...
      reloadModules();
      var el = createElementFromHTML('<img alt="{{myAltText}}" my-directive>');
      $compile(el)($rootScope);
  ...
  describe("components", () => {
    ...
    it("cannot be applied to an attribute", async () => {
      ...
      reloadModules();
      var el = createElementFromHTML("<div my-component></div>");
      $compile(el)($rootScope);
      await wait();
    ...
    it("may require other directive controllers", () => {
      ...
      reloadModules();
      var el = createElementFromHTML("<first><second></second></first>");
      $compile(el)($rootScope);
  ...
  describe("lifecycle", () => {
    it("calls $onInit after all ctrls created before linking", () => {
      ...
      reloadModules();
      var el = createElementFromHTML("<first second></first>");
      $compile(el)($rootScope);
    ...
    it("does not call $onChanges for two-way bindings", () => {
      ...
      reloadModules();
      var el = createElementFromHTML(
        '<my-component my-binding="42"></my-component>',
      );
      $compile(el)($rootScope);
    ...
    it("calls $onChanges when binding changes", async () => {
      ...
      $rootScope.aValue = 42;
      var el = createElementFromHTML(
        '<my-component my-binding="aValue"></my-component>',
      );
      $compile(el)($rootScope);
      await wait();
  ...
  describe("compiler control", () => {
    ...
    describe("templateUrl", () => {
      ...
      describe("delay compile / linking functions until after template is resolved", () => {
        ...
        describe("replace and not exactly one root element", () => {
          ...
          //   expect(() => {
          //     $compile("<p template></p>")($rootScope);
          //     $rootScope.createElementFromHTML();
          //   }).toThrowError(/tplrt/);
          // });
    ...
    describe("isolated locals", () => {
      ...
      it("should not initialize scope value if optional expression binding with Object.prototype name is not passed", async () => {
        element = $compile("<div my-component></div>")($rootScope);
  ...
  describe("multi-element directive", () => {
    ...
    it("should set up and destroy the transclusion scopes correctly", () => {
      ...
      expect($rootScope.$children[0]).toBeTruthy();
      expect($rootScope.$children[0].$children[0]).toBeTruthy();
      ...
      //   <!---->
      // </div>
      // const ngIfStartScope = element.children[0].eq(0).scope();
      // const ngIfEndScope = element.children[0].eq(1).scope();
      ...
      expect($rootScope.$children[0]).toBeNull();
    ...
    it("should set up and destroy the transclusion scopes correctly", () => {
      ...
      // </div>
      // const ngIf1Scope = element.children[0].eq(0).scope();
      // const ngIf2Scope = element.children[0].eq(1).scope();
    ...
    fit("should throw error if unterminated", () => {
      module.directive("foo", () => ({
        multiElement: true,
      }));
      initInjector("test1");
    ...
    fit("should correctly collect ranges on multiple directives on a single element", async () => {
      module
    ...
    fit("should throw error if unterminated (containing termination as a child)", () => {
      module.directive("foo", () => ({
        multiElement: true,
      }));
      initInjector("test1");
    ...
    fit("should support data- prefix", async () => {
      $rootScope.show = false;
      element = $compile(
        "<div>" +
  ...
  describe("element replacement", () => {
    it("should broadcast $destroy only on removed elements, not replaced", async () => {
      const linkCalls = [];
      const destroyCalls = [];
    ...
    fit("should clean data of element-transcluded link-cloned elements", () => {
      testCompileLinkDataCleanup(
        '<div><div ng-repeat-start="i in [1,2]"><span></span></div><div ng-repeat-end></div></div>',
      );
    });

    fit("should clean data of element-transcluded elements", () => {
      testCompileLinkDataCleanup(
    ...
    fit("should clean data of elements removed for directive template", () => {
      testReplaceElementCleanup({});
    });
    fit("should clean data of elements removed for directive templateUrl", () => {
      testReplaceElementCleanup({ asyncTemplate: true });
    });
    fit("should clean data of elements transcluded into directive template", () => {
      testReplaceElementCleanup({ transclude: true });
    });
    fit("should clean data of elements transcluded into directive templateUrl", () => {
      testReplaceElementCleanup({ transclude: true, asyncTemplate: true });
    });
    fit("should clean data of elements replaced with directive template", () => {
      testReplaceElementCleanup({ replace: true });
    });
    fit("should clean data of elements replaced with directive templateUrl", () => {
